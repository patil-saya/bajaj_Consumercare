...
<html lang="en">
   <head>
     <?php require_once("head.php"); ?>
       <title>ADITYA VIKRAM RAMESH SOMANI | Bajaj Consumer Care Ltd</title>
...
<meta property="og:url" content="<?php echo $actual_link ?>/Aditya-Vikram-Ramesh-Somani.php" />
         ...
         <div class="container">
            <div class="vision-wrapper main-wrapper" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
               <div class="vision-single single-vision-bod">
                  <div class="img-wrapp">
                  <img src="assets/images/aaditya.png" class="img-fluid" alt="MR. ADITYA VIKRAM RAMESH SOMANI">
               </div>
               </div>
               <div class="vision-single ">
                  <h2 class="f-bold">MR. ADITYA VIKRAM RAMESH SOMANI</h2>
                  <h3 class="f-semibold">Independent & Non-Executive Director</h3>
                  <p class="f-regular">Mr. Aditya Vikram Ramesh Somani holds a Master’s degree in Commerce from Sydenham College, Mumbai, a Master’s in Business Administration from the University of Pittsburgh, USA, among other educational accolades. He is the Promoter & Director of Everest Industries Limited.</p>
