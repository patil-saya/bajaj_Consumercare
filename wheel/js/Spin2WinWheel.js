function Spin2WinWheel() {
  ...
  var xmlns = "http://www.w3.org/2000/svg",
    ...
    spinInertiaPlugin,
    gameResultsArray = [],
    pegSnd = new Audio('wheel/media/wheel_tick.mp3'),
  ...
  showInitError = function(str) {
    ...
    showToast = function(str) {
      ...
      var detailText = '';
      if(str.includes("Jackpot")){
        detailText = 'Fill in the details to participate.';
        // document.getElementById('address').style.display = 'none';
        // document.getElementById('break').style.display = 'none';
        // document.getElementById('address').required = false;
      }else if(str.includes("hamper")){
        detailText = 'Fill in the details to receive your hamper.';
      }else if(str.includes("Amazon")){
        detailText = 'Fill in the details to redeem your voucher code.';
        // document.getElementById('address').style.display = 'none';
        // document.getElementById('break').style.display = 'none';
        // document.getElementById('address').required = false;
      }
      var detailPara = document.getElementById("detailPara");
      detailPara.innerHTML = detailText;

      var result = document.getElementById("result");
      document.getElementById("contact").style.display = "block";
      document.getElementById("spinBtn").style.visibility  = "hidden";
      document.getElementById("spinPara").style.visibility  = "hidden";
      result.value = str;
      gsap.fromTo(toast, {
        y: 20,
        opacity: 0
