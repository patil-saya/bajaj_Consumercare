...
showResult=function(a){w||C[0].applyBounds({minRotation:-1E16*F,maxRotation:G});"invalidSpin"==a?(gsap.set(f,{rotation:g[n]}),showToast(ja),a={target:y,type:"error",spinCount:n,win:null,msg:ja,gameId:T},na(a),L.push(a)):isNaN(a)||(showToast(m[a].resultText),a={target:y,type:"result",spinCount:n,win:m[a].win,msg:m[a].resultText,gameId:T,userData:m[a].userData},oa(a),L.push(a))};showInitError=function(a){gsap.set([Z,r],{autoAlpha:0});gsap.delayedCall(.1,function(){alert(a)})};
