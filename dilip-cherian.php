...
<html lang="en">
   <head>
     <?php require_once("head.php"); ?>
       <title>DILIP CHERIAN | Bajaj Consumer Care Ltd</title>
...
<meta property="og:url" content="Dilip-Cherian.php" />
         ...
         <div class="container">
            <div class="vision-wrapper main-wrapper" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
               <div class="vision-single single-vision-bod">
                  <div class="img-wrapp">
                  <img src="assets/images/bod-dilip.jpg" class="img-fluid" alt="MR. DILIP CHERIAN">
               </div>
               </div>
               <div class="vision-single ">
                  <h2 class="f-bold">MR. DILIP CHERIAN</h2>
                  <h3 class="f-semibold">Independent & Non-Executive Director</h3>
                  <p class="f-regular">Mr. Dilip Cherian is a veteran in the field of Public Relations. He has a long-standing career in varied fields including journalism and management consulting. He is on the board of various government and non-profit making organizations like the Advertising Standards Council of India Ahmedabad, etc.</p>
