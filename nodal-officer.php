         ...
         <div class="container breadcum_container">
            <div class="caption-breadcrum">
               <div class="caption-heading  bod-heading">
                  <h1 class="f-black">NODAL OFFICER</h1>
               </div>
            </div>
         </div>
      </section>
           ...
           <!--  <div class="heading">
            ...
            <div class="announcement-wrapper">
               <div class="announcement-single">
                  ...
                  <h5 class="f-bold">Contact details of Nodal Officer</h5>
                  <a href="pdf/Nodal Officer.pdf" download class="common-btn">DOWNLOAD PDF</a>
               </div>
            </div>
