...
<html lang="en">
   <head>
     <?php require_once("head.php"); ?>
       <title>SUMIT MALHOTRA | Bajaj Consumer Care Ltd</title>
...
<meta property="og:url" content="Sumeet-Malhotra.php" />
         ...
         <div class="container">
            <div class="vision-wrapper main-wrapper" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
               <div class="vision-single single-vision-bod">
                  <div class="img-wrapp">
                  <img src="assets/images/Mr-Sumit-Malhotra.jpg" class="img-fluid" alt="MR. SUMIT MALHOTRA">
               </div>
               </div>
               <div class="vision-single ">
                  <h2 class="f-bold">MR. SUMIT MALHOTRA</h2>
                  <h3 class="f-semibold">Director and Advisor</h3>
                  <p class="f-regular">Mr. Sumit Malhotra joined the Board as Director on 1st July 2020. Before this, he served Bajaj Consumer Care as its Managing Director from August 2011 till June 2020 and altogether worked for 16 years in the company in senior positions. He holds a Bachelor’s Degree in Pharmacy from IIT – BHU & and a PGDM from IIM - Ahmedabad. He has over 31 years of experience in the FMCG sector.</p>
