         ...
         <div class="container breadcum_container">
            <div class="caption-breadcrum">
               <div class="caption-heading  bod-heading">
                  <h1 class="f-black">INDEPENDENT DIRECTORS</h1>
               </div>
            </div>
         </div>
      </section>
           ...
           <!--  <div class="heading">
            ...
            <div class="announcement-wrapper">
               <div class="announcement-single">
                  ...
                  <h5 class="f-bold">Terms and Conditions for appointment <br>of Independent Director</h5>
                  <a href="pdf/Terms_and_Conditions_for_appointment_of_Independent_Director.pdf" download class="common-btn">DOWNLOAD PDF</a>
               </div>
            </div>
