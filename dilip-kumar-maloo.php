...
<html lang="en">
   <head>
     <?php require_once("head.php"); ?>
       <title>DILIP KUMAR MALOO | Bajaj Consumer Care Ltd</title>
...
<meta property="og:url" content="Dilip-Kumar-Maloo.php" />
         ...
         <div class="container">
            <div class="vision-wrapper main-wrapper" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
               <div class="vision-single single-vision-bod">
                  <div class="img-wrapp">
                  <img src="assets/images/Mr.-Dilip-Kumar-Maloo.jpg" class="img-fluid" alt="MR. DILIP KUMAR MALOO">
               </div>
               </div>
               <div class="vision-single ">
                  <h2 class="f-bold">MR. DILIP KUMAR MALOO</h2>
                  <h3 class="f-semibold">Chief Financial Officer</h3>
                    <p class="f-regular">Dilip Kumar Maloo is a qualified CA & CS professional. He has over 30 years of professional experience across various disciplines of Finance, Treasury & Secretarial functions. He has spearheaded multiple growth initiatives at BCL in the last two decades.</p>
